  ...
  <body>
    ...
    ?>
      ...
      <div class="semibox">
       ...
       <h1 style="color:white; text-align:center ">Welcome to PBL Bank Customer Login</h1>
...
<div class="container">
<div class="formcol">
<form class="row g-3" action="customerloginhandle.php" method="POST">
...
<label for="inputName" class="form-label">Account Holder Name</label>
  ...
  <div class="">
  <label for="inputAccountNo" class="form-label">Account Number</label>
    <input type="text" class="form-control" name="accountno" placeholder="Enter Your Account Number" aria-label="Account Number">
  </div>
  <div class="">
    <label for="password" class="form-label">Password</label>
    <input  type="text" name="password" class="form-control"  placeholder="Enter Password" id="exampleInputPassword1">
  </div>
